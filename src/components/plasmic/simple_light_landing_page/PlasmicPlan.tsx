...
import BaseCard from "../../BaseCard" // plasmic-import: P1MR0Z05n1AV0g/component
...
import * as sty from "./PlasmicPlan.module.css" // plasmic-import: 2OW-4uCv6unmeU/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__wDEut)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__vHwc0)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__lll6D)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__wqpcK)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__vrzaA)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__om8GJ)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.box___30Yuy)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
