...
import * as sty from "./PlasmicAvatar.module.css" // plasmic-import: ivvdyrFou9tZ7o/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__akwIg)}
            role={"img"}
