...
import * as sty from "./PlasmicIconLink.module.css" // plasmic-import: 6ZlhkOhYrokvL0/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg___9Vibt)}
              role={"img"}
            />
          ),
