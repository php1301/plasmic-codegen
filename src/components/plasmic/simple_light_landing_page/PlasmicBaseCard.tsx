...
import * as sty from "./PlasmicBaseCard.module.css" // plasmic-import: P1MR0Z05n1AV0g/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__yzi0J, {
          [sty.box__long__yzi0JNiwve]: hasVariant(variants, "long", "long"),
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__u3N6T, {
            [sty.box__long__u3N6TNiwve]: hasVariant(variants, "long", "long"),
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__uGwfP)}
                role={"img"}
              />
            ),
