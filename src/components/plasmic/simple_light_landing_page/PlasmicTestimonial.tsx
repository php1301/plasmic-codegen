...
import Avatar from "../../Avatar" // plasmic-import: ivvdyrFou9tZ7o/component
...
import * as sty from "./PlasmicTestimonial.module.css" // plasmic-import: luSlPCQot8utWc/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes" // plasmic-import: yXdXvyIR3d-s2O/icon
import profilepicMch6O8PCapPmOc from "./images/profilepic.png" // plasmic-import: mch6o8PCapPMOc/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__sw9Gu)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___6RzHo)}
        >
          <div
            className={classNames(
              defaultcss.all,
