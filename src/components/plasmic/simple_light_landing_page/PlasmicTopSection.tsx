...
import * as sty from "./PlasmicTopSection.module.css" // plasmic-import: JQSuKUKYvDIHlu/css

import heroImageJNxZhaGbaMwiD from "./images/heroImage.png" // plasmic-import: jNxZhaGBAMwi-d/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___8Fxpi)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__krCvm)}
        >
          <div className={classNames(defaultcss.all, sty.box__dLmA)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__aS229)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__gHmwe)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__mDgRz)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__lPtB)}>
          <img
