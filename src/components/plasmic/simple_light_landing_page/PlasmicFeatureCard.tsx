...
import * as sty from "./PlasmicFeatureCard.module.css" // plasmic-import: C5PGxwYR786ONF/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__qd98, {
            [sty.box__long__qd98XiqIa]: hasVariant(variants, "long", "long"),
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box__lQvXm, {
              [sty.box__long__lQvXmxiqIa]: hasVariant(variants, "long", "long"),
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg__b9Fyy)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__ltb4, {
          [sty.box__long__ltb4XiqIa]: hasVariant(variants, "long", "long"),
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__jhD4, {
            [sty.box__long__jhD4XiqIa]: hasVariant(variants, "long", "long"),
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__opjur)}
                role={"img"}
              />
            ),
