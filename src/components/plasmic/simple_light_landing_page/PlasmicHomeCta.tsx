...
import * as sty from "./PlasmicHomeCta.module.css" // plasmic-import: Mnr7gzWjzRaTAZ/css

import SphereIcon from "./icons/PlasmicIcon__Sphere" // plasmic-import: 707JcbrhpFpUQS/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__yp28G)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__ljV1S)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__xkrMl)}>
          <SphereIcon
