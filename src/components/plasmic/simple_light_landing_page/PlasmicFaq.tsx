...
import * as sty from "./PlasmicFaq.module.css" // plasmic-import: FjHfykApdRdzBD/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__gcr8W)}
      >
        <div className={classNames(defaultcss.all, sty.box___7IVfp)}>
          <div className={classNames(defaultcss.all, sty.box__c8EKk)}>
            {p.renderPlasmicSlot({
